...
const SearchMoviePlaySection = () => {
  ...
  const playlistToplayMovie = playlistMovies[0];
  return (
          ...
          <div className="w-full lg:w-[65%] xl:w-[70%]">
            ...
            <div className="relative w-full pt-[56.25%] bg-black">
              <div className="absolute top-0 left-0 w-full h-full">
                <SearchVideo playMovie={playlistToplayMovie} />
            ...
            <div className="mt-4 pb-6 border-b border-gray-800">
              <h1 className="text-xl font-bold text-white">{playlistToplayMovie?.title}</h1>
              <p className="mt-2 text-gray-400">{playlistToplayMovie?.overview}</p>
            </div>
          </div>
           <PlaylistSection/>
        </div>
